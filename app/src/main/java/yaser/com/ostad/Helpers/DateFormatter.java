...
package yaser.com.ostad.Helpers;
...
public final class DateFormatter {
    ...
    public static String format(Date date, String format) {
        ...
        return JalaliCalendar.gregorianToJalali(new JalaliCalendar.YearMonthDate(Integer.parseInt((String) DateFormat.format("yyyy", date)), Integer.parseInt((String) DateFormat.format("MM", date)), Integer.parseInt((String) DateFormat.format("dd", date)))).toString();
    }
