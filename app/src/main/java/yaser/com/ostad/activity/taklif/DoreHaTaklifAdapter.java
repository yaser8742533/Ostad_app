...
public class DoreHaTaklifAdapter extends RecyclerView.Adapter<DoreHaTaklifAdapter.ViewHolder> {

    TaklifActivity context;
    View itemView;
    ArrayList<Integer> arrayList;

    public DoreHaTaklifAdapter(TaklifActivity context, ArrayList<Integer> arrayList) {
