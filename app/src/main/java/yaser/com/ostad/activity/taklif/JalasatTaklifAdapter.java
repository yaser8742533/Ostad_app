...
public class JalasatTaklifAdapter extends RecyclerView.Adapter<JalasatTaklifAdapter.ViewHolder> {

    TaklifActivity context;
    View itemView;
    ArrayList<Integer> arrayList;

    public JalasatTaklifAdapter(TaklifActivity context, ArrayList<Integer> arrayList) {
